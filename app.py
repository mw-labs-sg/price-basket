...
@media(max-width:700px){
  ...
  .shell{border-radius:8px;-webkit-overflow-scrolling:touch}.t{font-size:9px;min-width:1060px}.t th,.t td{padding:4px 5px}
  .t th:first-child,.t td:first-child{position:sticky;left:0;z-index:3;background:#f5f8f6}.t th:nth-child(2),.t td:nth-child(2){position:sticky;left:64px;z-index:3;background:#fff;box-shadow:3px 0 5px rgba(20,50,35,.05)}
  .t th:first-child{z-index:5}.t th:nth-child(2){z-index:5}.cat{width:64px}.item{min-width:120px}.note{font-size:8px}
}
</style>
...
body = '''<tr class="delivery-row"><td class="cat">DELIVERY</td><td class="item">Delivery fee</td>
...
<tr class="delivery-row last"><td></td><td class="item">Free delivery from</td>
